        ...
        <section className="hero" style={{ backgroundColor: "#26262f" }}>
            ...
            <div className="grid max-w-screen-xl px-4 pt-8 mx-auto lg:gap-8 xl:gap-0 lg:pt-16 lg:grid-cols-12">
                ...
                <div className="ml-auto place-self-center lg:col-span-8">
                    ...
                    <a href="/demo-request" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border border-gray-300 rounded-lg focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        Request a Demo
                    </a>
                </div>
